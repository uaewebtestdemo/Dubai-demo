...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Dynamic Entrance Animation for Toggle ---
    const masterToggleWrapper = document.querySelector('.master-toggle-wrapper');
    if (masterToggleWrapper) {
        masterToggleWrapper.style.opacity = '0';
        masterToggleWrapper.style.transform = 'translateY(-20px)';
        masterToggleWrapper.style.transition = 'all 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275)';

        setTimeout(() => {
            masterToggleWrapper.style.opacity = '1';
            masterToggleWrapper.style.transform = 'translateY(0)';
        }, 100);
    }
});
